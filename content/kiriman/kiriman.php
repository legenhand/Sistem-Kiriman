...
<hr>
<a class="btn btn-success" href="?hal=kiriman/tambah"><i class="oi oi-plus"></i> Tambah</a>
...
?>
        <tr>
            <td><?= $no ?></td>
            <td><a href="?hal=kiriman/detail&id=<?= $data['no_resi'] ?>"><?= $data['no_resi'] ?></a></td>
            ...
            <td>
                ...
                <a href="?hal=kiriman/edit&id=<?= $data['no_resi']?>" class="btn btn-sm btn-info"><i class="oi oi-pencil"></i> Edit</a>
                <a href="?hal=kiriman/hapus&id=<?= $data['no_resi'] ?>" class="btn btn-sm btn-danger"><i class="oi oi-delete"></i> hapus</a>
            </td>
        </tr>
    <?php
        }
